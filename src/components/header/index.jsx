      ...
      <div className="container">
        <div className="header-content">
          <div className="row">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <Link to="/blog-left">Blog Left sidebar</Link>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <Link to="/blog-details-left" title="">
                              Blog single Left sidebar
                            </Link>
                          </li>
                          <li>
                            <Link to="/blog-details-fullwidth" title="">
            ...
            <div className="col-md-8 col-sm-8 col-4 d-lg-none">
              <MobileMenu />
            </div>
          </div>
